                ...
                <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                    <div className='flex flex-col gap-2 '>
                        ...
                        >
                            ...
                            {games.map(games => {
                                return <option key={games.id} value={games.id}>{games.title} </option>
                            })}
                        </select>
                    ...
                    <div>
                        ...
                        <Input name='name' id='name' type='text' placeholder='Selecione o nome' />
                    </div>
                    <div>
                        <div className='grid grid-cols-2 gap-6'>
                            <div className='flex flex-col gap-2 '>
                                <label htmlFor='yearsPlaying' className=''>Joga a quantos anos</label>
